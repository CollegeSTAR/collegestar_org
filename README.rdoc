...
7. Navigate or cd to your collegestar_org directory and type the following commmands "$vagrant init", "$vagrant vb-guest", "$vagrant ssh", "$vagrant up", "$bin/rails server --binding 0.0.0.0" to launch the rails app.
