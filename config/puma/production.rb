...
#
directory '/home/deploy/collegestar_org/current'
...
#
pidfile '/home/deploy/collegestar_org/current/tmp/pids/puma.pid'

# Use "path" as the file to store the server info state. This is
# used by "pumactl" to query and control the server.
#
state_path '/home/deploy/collegestar_org/current/tmp/pids/puma.state'
