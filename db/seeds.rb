...
roles = [
  ...
  { name: "modules_admin", description: "UDL Module Administrator: Administration rights over Udl Modules.", grantable: true },
  { name: "modules_author", description: "UDL Module Author: Rights to create Udl Modules.", grantable: true },
